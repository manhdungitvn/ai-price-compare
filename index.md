...
<div class="two">
<div><h2>Riêng tư từ thiết kế</h2><p class="sub">AI là <b>Gemini Nano tích hợp trong Chrome</b>, chạy trên máy bạn. Không máy chủ, không tài khoản, không analytics. Tìm kiếm đi thẳng từ trình duyệt tới trang tìm kiếm công khai của sàn — y như bạn tự tìm. Không có Gemini Nano vẫn dùng được đầy đủ (nhận xét theo luật nội bộ).</p><p><a href="{{ '/PRIVACY' | relative_url }}">Đọc chính sách quyền riêng tư →</a></p></div>
